...
<svelte:head>
    <meta name="author" content={env.PUBLIC_PROJECT_AUTHOR?? ""}/>
    ...
    <meta name="application-name" content={env.PUBLIC_PROJECT_TITLE?? ""}/>
    <meta name="apple-mobile-web-app-title" content={env.PUBLIC_PROJECT_TITLE?? ""}/>
    <meta name="msapplication-tooltip" content={env.PUBLIC_PROJECT_TITLE?? ""}/>
